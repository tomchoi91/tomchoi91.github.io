...
plotter1(data=milk_lbs_ecm, x=breed, y=ecm, fill=breed, 
         image=image, label=ecm ,vjust=-0.5) +
...
plotter1(data=component_lbs, x=breed, y=fat_protein_lbs, fill=breed, 
         image=image, label=fat_protein_lbs, vjust=-0.5) +
...
p <- ggplot(milk_by_time, aes(x=date, y=milk_lbs)) +
...
# Most basic bubble plot
p <- ggplot(milk_by_time_holstein, aes(x=date, y=milk_lbs)) +
...
# Most basic bubble plot
p <- ggplot(milk_by_time_jersey, aes(x=date, y=milk_lbs)) +
...
# Most basic bubble plot
p <- ggplot(milk_by_time_crossbred, aes(x=date, y=milk_lbs)) +
